...
class DashBoardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // body: Padding(
      //   // EdgeInsets.all() gives padding from al 4 sids
      //   // EdgeInsets.only() is used when padding need to be given from particular sides
      ...
      // )
      // --------------
      // by default we dont have any Margin widet but we can use it within a container widget
      body: Container(
        margin: EdgeInsets.all(11),
        child: Padding(
          // within container spacing allowed by padding
          padding: const EdgeInsets.all(8.0),
          child: Text(
            'Namaste Guruji',
            style: TextStyle(fontSize: 25),
